...
All notable changes to @system/audio will be documented in this file.
...
- Declared external command requirements: pactl
...
- Package naming now includes collection scope: `@system/audio`
