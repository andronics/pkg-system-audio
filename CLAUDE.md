# audio - AI Assistant Instructions
...
**Description**: Audio Control - Volume, playback, and device management

**Purpose**: Provide audio control - volume, playback, and device management functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/audio` - Main executable
...
1. **Test installation**: `stow audio`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D audio`
